...
@endif
    ...
    <form method="post" action="" autocomplete="off">
        ...
        <div class="form-group row">
            <label for="tipo_de_servicio" class="col-lg-2 control-label offset-md-1 requerido">
                <i id="IcNewEmp" class="bi bi-archive"></i>Tipo de servicio funerario</label>
            <div class="col-sm-8">
                <input type = "text"
                       oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                       maxlength = "25" name="tipo_de_servicio" id="tipo_de_servicio"
                       placeholder="Tipo de servicio funerario." class="form-control"
                       value="{{old('tipo_de_servicio', $cliente->tipo_de_servicio ?? '')}}"/>
            </div>
        </div>

        <div class="form-group row">
            <label for="nombre_beneficiario_1" class="col-lg-2 control-label offset-md-1 requerido">
                <i id="IcNewEmp" class="bi bi-person-fill"></i>Nombre del beneficiario N°1</label>
            <div class="col-sm-8">
                <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                       type = "text" maxlength = "60" name="nombre_beneficiario_1" id="nombre_beneficiario_1"
                       placeholder="Nombre completo del beneficiario." class="form-control"
                       value="{{old('nombre_beneficiario_1', $cliente->nombre_beneficiario_1 ?? '')}}"/>
            </div>
        </div>


        <div class="form-group row">
            <label for="telefono_beneficiario_1" class="col-lg-2 control-label offset-md-1 requerido">
                <i id="IcNewEmp" class="bi bi-telephone-forward"></i>Teléfono del Beneficiario N°1</label>
            <div class="col-sm-8">
                <input type="text" placeholder="Número de teléfono del beneficiario." maxlength="8"
                       id="telefono_beneficiario_1" name="telefono_beneficiario_1" class="form-control"
                       oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                       value="{{old('telefono_beneficiario_1', $cliente->telefono_beneficiario_1 ?? '')}}"/>
            </div>
        </div>


        <div class="form-group row">
            <label for="nombre_beneficiario_2" class="col-lg-2 control-label offset-md-1 requerido">
                <i id="IcNewEmp" class="bi bi-person-fill"></i>Nombre del beneficiario N°2</label>
            <div class="col-sm-8">
                <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                       type = "text" maxlength = "60" name="nombre_beneficiario_2" id="nombre_beneficiario_2"
                       placeholder="Nombre completo del beneficiario." class="form-control"
                       value="{{old('nombre_beneficiario_2', $cliente->nombre_beneficiario_2 ?? '')}}"/>
            </div>
        </div>


        <div class="form-group row">
            <label for="telefono_beneficiario_2" class="col-lg-2 control-label offset-md-1 requerido">
                <i id="IcNewEmp" class="bi bi-telephone-forward"></i>Teléfono del Beneficiario N°2</label>
            <div class="col-sm-8">
                <input type="text" placeholder="Número de teléfono del beneficiario." maxlength="8"
                       id="telefono_beneficiario_2" name="telefono_beneficiario_2" class="form-control"
                       oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                       value="{{old('telefono_beneficiario_2', $cliente->telefono_beneficiario_2 ?? '')}}"/>
            </div>
        </div>


        <div class="form-group row">
            <label for="nombre_beneficiario_3" class="col-lg-2 control-label offset-md-1 requerido">
                <i id="IcNewEmp" class="bi bi-person-fill"></i>Nombre del beneficiario N°3</label>
            <div class="col-sm-8">
                <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                       type = "text" maxlength = "60" name="nombre_beneficiario_3" id="nombre_beneficiario_3"
                       placeholder="Nombre completo del beneficiario." class="form-control"
                       value="{{old('nombre_beneficiario_3', $cliente->nombre_beneficiario_3 ?? '')}}"/>
            </div>
        </div>


        <div class="form-group row">
            <label for="telefono_beneficiario_3" class="col-lg-2 control-label offset-md-1 requerido">
                <i id="IcNewEmp" class="bi bi-telephone-forward"></i>Teléfono del Beneficiario N°3</label>
            <div class="col-sm-8">
                <input type="text" placeholder="Número de teléfono del beneficiario." maxlength="8"
                       id="telefono_beneficiario_3" name="telefono_beneficiario_3" class="form-control"
                       oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                       value="{{old('telefono_beneficiario_3', $cliente->telefono_beneficiario_3 ?? '')}}"/>
            </div>
        </div>

        <div class="form-group row">
            <label for="nombre_beneficiario_4" class="col-lg-2 control-label offset-md-1 requerido">
                <i id="IcNewEmp" class="bi bi-person-fill"></i>Nombre del beneficiario N°4</label>
            <div class="col-sm-8">
                <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                       type = "text" maxlength = "60" name="nombre_beneficiario_4" id="nombre_beneficiario_4"
                       placeholder="Nombre completo del beneficiario." class="form-control"
                       value="{{old('nombre_beneficiario_4', $cliente->nombre_beneficiario_4 ?? '')}}"/>
            </div>
        </div>


        <div class="form-group row">
            <label for="telefono_beneficiario_4" class="col-lg-2 control-label offset-md-1 requerido">
                <i id="IcNewEmp" class="bi bi-telephone-forward"></i>Teléfono del Beneficiario N°4</label>
            <div class="col-sm-8">
                <input type="text" placeholder="Número de teléfono del beneficiario." maxlength="8"
                       id="telefono_beneficiario_4" name="telefono_beneficiario_4" class="form-control"
                       oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                       value="{{old('telefono_beneficiario_4', $cliente->telefono_beneficiario_4 ?? '')}}"/>
            </div>
        </div>
        <br>
