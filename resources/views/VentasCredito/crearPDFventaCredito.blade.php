   ...
   <!-- <script language="javascript">alert("Para exportar el contrato a PDF y poder imprimirlo, haz clíc en el logo de la funeraria.")</script>-->
    ...
    <body>
        ...
        <div class="contrato">
            ...
            Yo: <a class="hh"><b>{{$creditoventa->clientes->nombres}} {{$creditoventa->clientes->apellidos}}</b></a> con cédula de identidad personal No. <b>{{$creditoventa->clientes->identidad}}</b> de profesión u oficio <a class="hh"><b>{{$creditoventa->clientes->ocupacion}}</b></a> con domicilio en <a class="hh"><b>{{$creditoventa->clientes->direccion}}</b></a> y
            ...
            <ol>
                ...
                <li > <b>{{$creditoventa->beneficiario2}}</b></li>
                <li > <b>{{$creditoventa->beneficiario3}}</b></li>
                <li > <b>{{$creditoventa->beneficiario4}}</b></li>
            ...
            <div class="claus">
                <b>A)</b> En caso que no se siga con el pago de la póliza se anulará el contrato sin hacer reembolso de las cuotas previamente pagadas.<br>
                <b>B)</b> El comprador manifiesta que recibe el ataúd a su entera satisfacción, y debidamente informado del estado del mismo y de sus elementos.<br>
                <b>C)</b> El vendedor hace entrega del ataúd al comprador, haciéndose éste responsable, desde este momento, de cuantas cuestiones puedan derivarse del uso o posesión del mismo.<br>
                <b>D)</b> Los demás elementos que incluye el servicio como ser: carretilla, crucifijo, lámparas, floreros, candelabros y capilla, deben ser devueltos a la empresa el día siguiente del sepelio.<br>
                <b>E)</b> El contratante tiene 10 días hábiles para presentarse a la empresa para cancelar el costo en caso de que se presente un daño a los demás elementos que incluye el servicio como ser: lámparas, crucifijo, carretilla, etc.<br>
                <b>F)</b> Para la resolución de las cuestiones que pudieran surgir, derivadas del presente contrato de venta al contado, las partes quedan sometidas a los Juzgados y Tribunales competentes, como lugar de celebración del contrato y cumplimiento de las obligaciones del mismo.<br>
                <b>G)</b> Exclusivamente, el contratante tiene derecho a traslado del cadáver dentro del país, y si fuese para otra persona familiar o particular, mientras sea en el casco urbano, se prestará el traslado convenido, y en caso que sea afuera de la zona, se hará efectivo el pago conforme a la distancia del traslado..<br>
                <b>H)</b> El asegurado podrá hacer uso del servicio funerario para quien el estime conveniente a partir del momento que firme este contrato,
                y si el contratante ocupare el servicio funerario durante los primeros seis meses despues de firmado el contrato pagará un 50% del valor del servicio funerario y el saldo lo pagará en las cuotas establecidas.<br>
        ...
        <div>
            <a class="date1"><b>Hora y fecha de venta:</b></a> <a class="date2">{{$creditoventa->created_at->format('h:iA d-m-Y')}}</a>
        </div><br><br>
