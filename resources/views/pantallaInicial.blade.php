...
<section class="page-section">
    <div class="container" id="categorias">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-4 cat mt-4 mb-4">
            ...
            <div class="col-md-4 cat mt-4 mb-4">
                <a href="{{route('inventario.home')}}"><img src="/assets/inventario1.png" alt="Inventario" width="200px"><br>
                <a class="btn btn-success">Inventario</a>
            </div>
            @endcan
            @can('Listado_ventas')
            <div class="col-md-4 cat mt-4 mb-4">
                <a href="{{route('ventas.index')}}"><img src="/assets/ventas1.png" alt="Ventas" width="200px" class="mb-1"><br>
